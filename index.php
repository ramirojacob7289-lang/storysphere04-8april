...
_Hasync.push(['Histats.start', '1,5019165,4,0,0,0,00010000']);
...
<noscript><a href="/" target="_blank"><img  src="//sstatic1.histats.com/0.gif?5019165&101" alt="counter create hit" border="0"></a></noscript>
<!-- Histats.com  END  -->
        <meta charset="utf-8">
        ...
        <div id="main-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-6 col-md-6 col-lg-6 margin-bottom-20">
                                    <div class="black-bg col-sm-12 col-md-12 col-lg-12">
                                        <h2>WEB DESIGN</h2>
                                        <p>Zoom is free HTML5 website template for everyone. You can use this template for any purpose. Credit goes to <a rel="nofollow" href="http://unsplash.com">Unsplash</a> for photos used in this template. Integer posuere quam a orci tempor, ut eleifend est vulputate. Nullam vitae lectus dui. Donec vulputate ac tortor id convallis. Sed nisi mauris, laoreet vitae lacus at, viverra viverra neque.</p>
                                    </div>
                                </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 footer">
                    <p class="footer-text">Copyright &copy; 2084 Your Company Name</p>
                </div><!-- /.footer --> 
            </div>
